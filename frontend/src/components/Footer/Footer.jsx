...
const Footer = () => {
  return (
    <footer className="footer footer-center bg-gray-200 text-black py-10 mt-auto border-t-2 border-black">
      <div className="container mx-auto">
        ...
        <aside className="text-center">
          <p>
            &copy; {new Date().getFullYear()} Disaster Info Hub. All rights
            reserved.
          </p>
